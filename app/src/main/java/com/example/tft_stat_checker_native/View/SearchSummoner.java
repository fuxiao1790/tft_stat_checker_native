...
public class SearchSummoner extends FragmentActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        switch (requestCode) {
            case SearchSummoner.EDIT_SEARCH_TEXT: {
                if (resultCode == SearchSummoner.RESULT_OK) {
                    String newSearchText = data.getStringExtra(SearchSummoner.SEARCH_TEXT_RESULT_KEY);
                    String newPlatform = data.getStringExtra(SearchSummoner.PLATFORM_RESULT_KEY);
    ...
    public void iniSearchBar() {
        ...
        searchBar.setOnClickListener((view) -> {
            ...
            editSearchText.putExtra(SearchSummoner.SEARCH_TEXT_RESULT_KEY, summonerName);
            editSearchText.putExtra(SearchSummoner.PLATFORM_RESULT_KEY, platform);
            editSearchText.putExtra(SearchSummoner.SEARCH_HISTORY_KEY, searchHistoryManager.toJSON().toString());
            startActivityForResult(editSearchText, SearchSummoner.EDIT_SEARCH_TEXT);
        });
    }
